...
$pswindow.WindowTitle = "Total Online - Encryptors"
...
$asdf = Get-Content "..\gen\icmp-encryptors.htm"
...
$generatedFile = "..\gen\total-online-encryptors.htm "
$publishedFile = "..\gen-pub\total-online-encryptors.htm "
$HTMLHead = @"
<!DOCTYPE html>
<HEAD>
<META charset="UTF-8">
...
<tr><th colspan="2" style="font-size:9pt">Encryptors</th></tr>
