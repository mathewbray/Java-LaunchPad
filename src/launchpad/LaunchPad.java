...
"Button01StrExe=cmd /c start onenote.exe",
"Button01ToolTip=Notebook",
"Button02icon=dailyreport",
"Button02StrExe=cmd /c start explorer.exe \"%USERPROFILE%\\\\Desktop\\\\\"",
"Button02ToolTip=Daily Report",
"Button03icon=kanban",
"Button03StrExec=cmd /c start chrome.exe https://trello.com",
"Button03ToolTip=KanBan",
"Button04icon=alert",
"Button04StrExec=cmd /c start explorer.exe \"%USERPROFILE%\\\\Desktop\\\\\"",
"Button04ToolTip=Master Station Log",
"Button05icon=user-yellow-home-icon",
"Button05StrExec=cmd /c start explorer.exe ",
"Button06icon=folder-yellow-visiting-icon",
"Button06StrExec=cmd /c start explorer.exe ",
"Button07icon=folder-yellow-development-icon",
"Button07StrExec=cmd /c start explorer.exe \"%USERPROFILE%\\\\Desktop\\\\\"",
"Button08icon=folder-yellow-git-icon",
"Button08StrExec=cmd /c start explorer.exe \"%USERPROFILE%\\\\Desktop\\\\\"",
"Button09icon=infoblox",
"Button09StrExec=cmd /c start chrome.exe https://infoblox.com/",
"Button10icon=ciscodarkblue",
"Button10StrExec=cmd /c start chrome.exe https://cisco.com/",
"Button11icon=windowsblue",
"Button11StrExec=cmd /c start mstsc /v:SERVERNAME",
"Button12icon=coffee",
"Button12StrExec=cmd /c start \"\"",
"Button13icon=circuitboard",
"Button13StrExec=cmd /c start chrome.exe https://www.wireshark.org/tools/oui-lookup.html",
"Button14icon=favorites",
"Button14StrExec=cmd /c start chrome.exe",
"Button15icon=CygWin",
"Button15StrExec=",
"Button16icon=map",
"Button16StrExec=cmd /c start explorer.exe \"%USERPROFILE%\\\\Desktop\\\\\"",
"Button17icon=backup",
"Button17StrExec=",
"Button18icon=ipconfig",
"Button18exe-CMD-OPTION=cmd /c start cmd.exe /K \"ipconfig & pause\"",
"Button18StrExec=cmd /c start cmd.exe /k powershell.exe -ExecutionPolicy Bypass -noexit -Command \"& {$RunIPconfig = {Clear-Host; ipconfig /all; Write-Host ''; Write-Host 'Press Enter to REFRESH...' -NoNewLine  -ForegroundColor Green; Read-Host -Prompt ' '; .$RunIPconfig}; &$RunIPconfig}\"",
"Button19icon=winscp",
"Button19StrExec=",
"Button20icon=wifi",
