...
do {
        write-host ""
        write-host "                  GET NTP Time! " -ForegroundColor Green
        write-host ""
        write-host ""
        write-host -nonewline " Enter the IP of the NTP Server: " 
        ...
        Get-NtpTime -Server $ntpserver
        


} until ( $ntpserver -match "exit" )