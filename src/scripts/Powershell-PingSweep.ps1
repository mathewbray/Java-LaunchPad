...
#-- Variables
    ...
    $OutputFileSorted = ".\PingSweepOutputSorted-$RandomNumber.csv"
...
Import-CSV .\pingoutput.csv | Sort-Object -Property { [System.Version]$_.IPAddress } | Export-Csv .\pingoutput_sorted.csv -NoTypeInformation -Force
